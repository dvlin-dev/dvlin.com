...
- [GitHub - ryoppippi/sitemcp: Fetch an entire site and use it as a MCP Server](https://github.com/ryoppippi/sitemcp)
...
实现基于 mcp-framework 框架，代码： https://github.com/dvlin-dev/playground/tree/mcp/servers 对应目录

#### mcp server 接入

参考 chatbot server 的实现
